...
public class OperadorNao {
	...
	public static void main(String[] args) {
		/*Crie um programa que receba o tipo de um usuário em uma variável String e caso esse tipo NÃO SEJA "administrador", exibir a mensagem: "Atenção, usuário sem poderes administrativos. Algumas tarefas serão bloqueadas".*/
		...
		if (!tipoUsuario.equalsIgnoreCase("administrador")) {
			...
			System.out.println("Usuário com poderes administrativos. Nenhuma tarefa será bloqueadas");
		}
